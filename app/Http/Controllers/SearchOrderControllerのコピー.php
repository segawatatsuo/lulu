...
class SearchOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $param = array(
            'dateType' => 1, //1: 注文日
            'startDatetime' => '2023-09-25T00:00:00+0900', //期間検索開始日時
            'endDatetime' => '2023-09-29T23:59:59+0900', //期間検索終了日時
            //'startDatetime' => date("Y-m-d") . "T00:00:00+0900", //期間検索開始日時 過去 730 日(2年)以内の注文を指定可能
            //'endDatetime' => date("Y-m-d") . "T23:59:59+0900", //期間検索終了日時 開始日から 63 日以内

            'PaginationRequestModel:' => array( //ページングリクエストモデル
                'requestRecordsAmount : 50', //1ページあたりの取得結果数.最大 1000 件まで指定可能
                'requestPage : 2', //リクエストページ番号
                'SortModelList:' => array(
